<?php
	...
	class MissingRelationDefinitionException extends \Exception {
		public function __construct($relationTable, $class) {
			$this->message = "Missing relation definition for table {$relationTable} in class {$class}";
		}
	}
